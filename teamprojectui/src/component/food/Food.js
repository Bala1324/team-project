...
const Food = () => {
  ...
  const getfood = () => {
    ...
    axios.get("http://192.168.1.6:7000/api/v2/food/getallitem").then((res) => {
  ...
  const foodcategorys = () => {
    axios.get("http://192.168.1.6:7000/api/v2/food/getfoodcategory").then((res) => {
  ...
  const searchproduct = (key) => {
    console.log(key)
    axios.get('http://192.168.1.6:7000/api/v2/food/searchproduct/' + key, {
  ...
  const getProducts = (curElem) => {
    ...
    axios.get("http://192.168.1.6:7000/api/v2/food/get-categorybasedfooditem", {
  ...
  const getIndivData = async (data) => {
    ...
    await axios.get(`http://192.168.1.6:7000/api/v2/food/getIndifooddetails?food_uuid=${data}`, {
      headers: { "token": token }
    })
      .then((res) => {
        if (res.data.result) {
  ...
  const tableBookBtn = async () => {
    ...
    await axios.post('http://192.168.1.6:7000/api/v2/food/book-table', {
        ...
        <div className="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
          ...
          <nav id="navbar" className="navbar order-last order-lg-0">
            <ul>
              ...
              <li><img className="add-to-card" src="https://cdn-icons-png.flaticon.com/128/3081/3081559.png" alt="" onClick={() => navigate("/addtocart", { state: { cart } })}></img></li>
            </ul>
                ...
                return (
                  ...
                  <div className="col-lg-6 menu-item filter-starters" key={index}>
                    ...
                    <div className="menu-content">
                      ...
                      <span className="addto" style={{ backgroundColor: "white" }} onClick={() => addtocart(curElem)}>Add-to-card</span>
                    </div>
          ...
          <form role="form" className="php-email-form" data-aos="fade-up" data-aos-delay="100">
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 form-group mt-3">
                ...
                {/* <input type="text" name="date" className="form-control" id="date" placeholder="Date" data-rule="minlen:4" data-msg="Please enter at least 4 chars" onChange={e => setTableData(e.target)} /> */}
                <div className="validate"></div>
              </div>
              <div className="col-lg-4 col-md-6 form-group mt-3">
                <TimePicker className="form-control" onChange={setBookingTime} value={bookingTime} />
                {/* <input type="text" className="form-control" name="time" id="time" placeholder="Time" data-rule="minlen:4" data-msg="Please enter at least 4 chars" onChange={e => setTableData(e.target)} /> */}
                <div className="validate"></div>
              </div>
              <div className="col-lg-4 col-md-6 form-group mt-3">
